...
import static uk.gov.companieshouse.itemgroupconsumer.environment.EnvironmentVariablesChecker.RequiredEnvironmentVariables.BOOTSTRAP_SERVER_URL;
import static uk.gov.companieshouse.itemgroupconsumer.environment.EnvironmentVariablesChecker.RequiredEnvironmentVariables.CONCURRENT_LISTENER_INSTANCES;
import static uk.gov.companieshouse.itemgroupconsumer.environment.EnvironmentVariablesChecker.RequiredEnvironmentVariables.SERVER_PORT;
import static uk.gov.companieshouse.itemgroupconsumer.environment.EnvironmentVariablesChecker.RequiredEnvironmentVariables.GROUP_ID;
import static uk.gov.companieshouse.itemgroupconsumer.environment.EnvironmentVariablesChecker.RequiredEnvironmentVariables.INVALID_MESSAGE_TOPIC;
import static uk.gov.companieshouse.itemgroupconsumer.environment.EnvironmentVariablesChecker.RequiredEnvironmentVariables.MAX_ATTEMPTS;
import static uk.gov.companieshouse.itemgroupconsumer.environment.EnvironmentVariablesChecker.RequiredEnvironmentVariables.TOPIC;
