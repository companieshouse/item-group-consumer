package uk.gov.companieshouse.itemgroupconsumer.config;
...
import uk.gov.companieshouse.itemgroupconsumer.kafka.InvalidMessageRouter;
import uk.gov.companieshouse.itemgroupconsumer.kafka.MessageFlags;
