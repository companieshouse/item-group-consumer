artifact_name       := item-group-consumer
version             := "unversioned"
...
dependency-check:
	...
	DEPENDENCY_CHECK_SUPPRESSIONS_HOME="$${suppressions_home}" "$${suppressions_home}/scripts/depcheck" --repo-name=item-group-consumer
